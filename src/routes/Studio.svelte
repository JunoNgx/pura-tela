<script lang="ts">
	...
	import { getHexColourCodesInUse, getColourObjectsInUse, shouldShowSampleText, wallGenStyle, wallGenSize, readjustWallGenColoursInUseCount } from "src/states/wallGenState.svelte.js";
